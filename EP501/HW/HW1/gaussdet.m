function [detA]=gaussdet(A,varargin)
...
Amod = A;                 % create working copy of A
...
sgn = 1;                  % sign of constant multiplier
coef = 1;                 % constant multiplier that arises from eliminating elements
...
for ir1=1:n-1
    ...
    for ir2=ir1+1:n
        ...
        Amod(ord(ir2),ir1:n)=Amod(ord(ir2),ir1:n)-fact/Amod(ord(ir1),ir1).*Amod(ord(ir1),ir1:n);    %only need columns ahead of where we are in matrix
    end %for
